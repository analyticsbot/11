...
username = 'DeandreaGedding'
password = 'WX1733ikht'
email='SherieRadle1089583@mail.com'
bio = 'Devoted problem solver. Passionate creator. Subtly charming beer lover. Hipster-friendly food nerd.'
...
pwd_elem.submit()
HANDLE = 'Lattice' ## handle or product that has to be always upvoted 
